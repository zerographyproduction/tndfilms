    ...
    <div className='bg-white' ref={ref}>
      ...
      <section className='py-16 lg:py-24 bg-white'>
        <div className='max-w-6xl mx-auto px-6 lg:px-12 text-center'>
          ...
          >
            <h1 className='text-2xl md:text-3xl font-normal leading-tight mb-4 text-gray-900 tracking-wide'>
            ...
            <p className='text-sm text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8'>
              At the heart of TND Films is a collective of seasoned professionals, dedicated to bringing
              your brand's vision to life through exceptional video production.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className='max-w-6xl mx-auto px-6 lg:px-12'>
          <div className='grid lg:grid-cols-2 gap-12 items-center mb-16'>
            <motion.div
              ...
              transition={{ duration: 1 }}
            >
              <h2 className='text-xl md:text-2xl font-medium mb-4 text-gray-900'>
                Who We Are
              </h2>
              <div className='w-16 h-0.5 bg-red-500 mb-4' />
              <p className='text-sm text-gray-700 leading-relaxed mb-4'>
                TND Films is a premier video production company dedicated to bringing your stories to life through 
                the power of visual storytelling. We specialize in producing high-quality videos across a diverse 
                range of genres and formats.
              </p>
              <p className='text-xs text-gray-600 leading-relaxed mb-6'>
                From conceptualization to post-production, we handle every aspect of video production, 
                delivering content that captivates and engages your audience.
              </p>
            </motion.div>
